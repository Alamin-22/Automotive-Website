...
const Toyota_Card = ({ Single_toyota }) => {
    const { _id, name, brand, type, price, rating, photo,  quantity } = Single_toyota;
...
Toyota_Card.propTypes = {
    Single_toyota: PropTypes.object,
};

export default Toyota_Card;